...
document.getElementById("btn-1").onclick = function(){
	...
	console.log(target);
	 ...
	 if(userIn > 10 || userIn < 0){
		...
		document.getElementById("msg").innerHTML = "# The value is larger than " + userIn;
	} else if(userIn > target){
		document.getElementById("msg").innerHTML = "# The value is smaller than " + userIn;
	} else if(userIn == target){
		document.getElementById("msg").innerHTML = "# Kodus You Guessed The correct Number !"
	} else{
